...
import problem.constraint.Permutation; //attention
import utils.Utils;

public class ConstraintBuilder {

	public static boolean inCoronenoid(GeneralModel model, int x, int y) {
		int largeur = model.getDiameter();
		int nbCouronnes = model.getNbCrowns();
	...
	public static boolean inCoronenoid(GeneralModel model, int i) {
		int largeur = model.getDiameter();
		return inCoronenoid(model, i % largeur, i / largeur);
	}
