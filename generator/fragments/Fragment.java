...
public class Fragment {
	...
	public Fragment(int[][] matrix, int[] labels, Node[] nodesRefs, RelativeMatrix relativeMatrix, Node center, int [][] neighborGraph, int order) {
	...
	public static Fragment importFragment(File file) throws IOException {
		...
		RelativeMatrix relativeMatrix = new RelativeMatrix(8 * nodesLines.size() + 1, 16 * nodesLines.size() + 1, 4 * nodesLines.size(), 8 * nodesLines.size());
