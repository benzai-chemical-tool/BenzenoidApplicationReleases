...
public class MultipleFragments1Module extends Module {
	...
	public MultipleFragments1Module(GeneralModel generalModel, ArrayList<Fragment> fragments, VariableStrategy variableStrategy, ValueStrategy valueStrategy, OrderStrategy orderStrategy) {
		super(generalModel);
