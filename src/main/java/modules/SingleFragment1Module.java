...
public class SingleFragment1Module extends Module{
	...
	public SingleFragment1Module(GeneralModel generalModel, Fragment fragment, VariableStrategy variablesStrategy, ValueStrategy valueStrategy, OrderStrategy orderStrategy) {
		super(generalModel);
