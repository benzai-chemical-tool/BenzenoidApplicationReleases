...
public class FragmentGroup extends Group {
	...
	public FragmentGroup(int nbCrowns) {
	...
	public Fragment exportFragment() {
		...
		RelativeMatrix relativeMatrix = new RelativeMatrix(8 * nbHexagons + 1, 16 * nbHexagons + 1, 4 * nbHexagons, 8 * nbHexagons);
